...
public class GestorParametrosAnalisis {
	...
	public static List<ParametroNombre> getParamsTipoIndividual() {
		...
		lista.add(ParametroNombre.A_FAVOR);
		lista.add(ParametroNombre.INTERVENCIONES);
		lista.add(ParametroNombre.FALTAS_COMETIDAS);
		lista.add(ParametroNombre.FALTAS_RECIBIDAS);
		lista.add(ParametroNombre.PENALTY_FAVOR);
		lista.add(ParametroNombre.PENALTY_CONTRA);
		lista.add(ParametroNombre.FUERA_JUEGO_FAVOR);
		lista.add(ParametroNombre.FUERA_JUEGO_CONTRA);
		lista.add(ParametroNombre.BALONES_RECUPERADOS);
		lista.add(ParametroNombre.BALONES_PERDIDOS);
		lista.add(ParametroNombre.PASES_BUENOS);
		lista.add(ParametroNombre.PASES_TOTALES);
		lista.add(ParametroNombre.CENTROS_AREA);
		lista.add(ParametroNombre.ASISTENCIAS);
		lista.add(ParametroNombre.ASISTENCIA_CON_GOL);
		lista.add(ParametroNombre.JUGADORES_UTILIZADOS);
