...
public class PronosticoPartido {
	...
	/**
	 * @param porcentaje12  the porcentaje12 to set
	 * @uml.property  name="porcentaje12"
	 */
	...
	/**
	 * @param porcentaje1x  the porcentaje1X to set
	 * @uml.property  name="porcentaje1X"
	 */
	...
	/**
	 * @param porcentaje1x2  the porcentaje1X2 to set
	 * @uml.property  name="porcentaje1X2"
	 */
	...
	/**
	 * @param porcentajeX  the porcentajeX to set
	 * @uml.property  name="porcentajeX"
	 */
	...
	/**
	 * @param porcentajeX2  the porcentajeX2 to set
	 * @uml.property  name="porcentajeX2"
	 */
	...
	/**
	 * @param posicionPartido  the posicionPartido to set
	 * @uml.property  name="posicionPartido"
	 */
