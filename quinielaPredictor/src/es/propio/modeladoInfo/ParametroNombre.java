...
public enum ParametroNombre {
	...
	NUMEROJORNADA("NUMEROJORNADA"), JUEGA_EN_CASA("JUEGA_EN_CASA"), JUEGA_FUERA(
			...
			"JUGADORES_UTILIZADOS"), PARADAS_DEL_PORTERO("PARADAS_DEL_PORTERO"), A_FAVOR(
			"A_FAVOR"), AF_BALON_PARADO("AF_BALON_PARADO"), AF_CABEZA(
			"AF_CABEZA"), AF_FALTA_DIRECTA("AF_FALTA_DIRECTA"), AF_JUGADA_COLECTIVA(
			"AF_JUGADA_COLECTIVA"), AF_JUGADA_INDIVIDUAL("AF_JUGADA_INDIVIDUAL"), AF_PENALTY(
			"AF_PENALTY"), AF_PIE_IZQUIERDO("AF_PIE_IZQUIERDO"), AF_PIE_DERECHO(
			"AF_PIE_DERECHO"), EN_CONTRA("EN_CONTRA"), GC_CABEZA("GC_CABEZA"), GC_PENALTY(
			"GC_PENALTY"), GOLES_TITULAR("GOLES_TITULAR"), GOLES_SUPLENTES(
			"GOLES_SUPLENTES"), REMATES_FAVOR("REMATES_FAVOR"), RF_BALON_PARADO(
			"RF_BALON_PARADO"), RF_CABEZA("RF_CABEZA"), RF_FUERA("RF_FUERA"), RF_JUGADA_COLECTIVA(
	...
	RC_CABEZA("RC_CABEZA"), RC_FUERA("RC_FUERA"), RC_PORTERIA("RC_PORTERIA"), RC_POSTE(
			...
			"TARJETAS_ROJAS"), FALTAS_COMETIDAS("FALTAS_COMETIDAS"), FALTAS_RECIBIDAS(
			"FALTAS_RECIBIDAS"), PENALTY_FAVOR("PENALTY_FAVOR"), PENALTY_CONTRA(
			"PENALTY_CONTRA"), FUERA_JUEGO_FAVOR("FUERA_JUEGO_FAVOR"), FUERA_JUEGO_CONTRA(
			"FUERA_JUEGO_CONTRA"), BALONES_RECUPERADOS("BALONES_RECUPERADOS"), BALONES_PERDIDOS(
			"BALONES_PERDIDOS"), PASES_BUENOS("PASES_BUENOS"), PASES_TOTALES(
			"PASES_TOTALES"), CENTROS_AREA("CENTROS_AREA"), ASISTENCIAS(
			"ASISTENCIAS"), ASISTENCIA_CON_GOL("ASISTENCIA_CON_GOL"), INTERVENCIONES(
			"INTERVENCIONES"),
	...
	public boolean isPositivo() throws Exception {
		...
		if (isTipoEquipoIndividual()) {
			...
			positivo = this.equals(NUMEROJORNADA)
					...
					|| this.equals(FALTAS_RECIBIDAS)
					|| this.equals(PENALTY_FAVOR)
					|| this.equals(FUERA_JUEGO_FAVOR)
					|| this.equals(BALONES_RECUPERADOS)
					|| this.equals(PASES_BUENOS) || this.equals(PASES_TOTALES)
					|| this.equals(CENTROS_AREA) || this.equals(ASISTENCIAS)
					|| this.equals(ASISTENCIA_CON_GOL)
